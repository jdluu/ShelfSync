...
1. Download the latest `.apk` file from the repository releases.
2. Transfer the file to your Android device or download it directly.
3. Open the `.apk` file on your device. You may need to enable "Install from Unknown Sources" in your system settings.
4. Follow the installation steps provided by the operating system.
